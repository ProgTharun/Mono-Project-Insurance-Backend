...
namespace InsurancePolicy.Models
{
    public class InsuranceScheme
    {
        ...
        [Range(500, double.MaxValue, ErrorMessage = "Minimum amount must be a greater than 5000.")]
        public double MinAmount { get; set; }

        [Required(ErrorMessage = "Maximum amount is required.")]
        [Range(1000, double.MaxValue, ErrorMessage = "Maximum amount must be a greater than 1000.")]
        ...
        [Range(18, 70, ErrorMessage = "Maximum age must be between 18 and 70.")]
